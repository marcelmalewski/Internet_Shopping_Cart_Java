...
@Getter
public class ListOfProducts implements List<Product> {
    ...
    @Override
    public void addElement(Product newProduct) {
    ...
    @Override
    public boolean removeElement(Product productToDelete){
    ...
    public Product[] peekElements(int numberOfElements) {
        return Arrays.copyOf(this.listOfProducts, numberOfElements);
    }

    public double sumDiscountPricesOfAllProducts() {
        double sum = 0;
    ...
    public void sortElementsAscByPrice() {
        this.sortProducts.sortProductsAscByPrice();
    }

    public void sortElementsDescByPrice() {
        this.sortProducts.sortProductsDescByPrice();
    }

    public void sortElementsAscByName() {
        this.sortProducts.sortProductsAscByName();
    }

    public void sortElementsDescByName() {
